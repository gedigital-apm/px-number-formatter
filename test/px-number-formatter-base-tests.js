...
function runBaseTests() {
  px_number_formatter_1 = document.getElementById('px_number_formatter_1');

  suite('Base Automation Tests for px-number-formatter', function() {
